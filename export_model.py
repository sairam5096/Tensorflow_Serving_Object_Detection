...
config_pathname = 'pre-trained-models/ssd_mobilenet_v2_coco_2018_03_29/pipeline.config'

# Input checkpoint for the model to be exported
# Path to the directory which consists of the saved model on disk (see above)
trained_model_dir = 'pre-trained-models/ssd_mobilenet_v2_coco_2018_03_29/'

Output_directory = 'pre-trained-models/ssd_mobilenet_v2_coco_2018_03_29/'
